...
OPTFLAGS	= -mtune=cortex-a15 -mcpu=cortex-a15 -marm -mfpu=neon-vfpv4 \
		  -fgraphite -ftree-vectorize -mvectorize-with-neon-quad -fgcse-sm \
		  -pipe
#		  -funroll-loops -fsched-spec-load -munaligned-access -fforce-addr -pipe
